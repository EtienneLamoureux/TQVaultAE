...
namespace TQVaultAE.Data
{
	...
	public class ItemAttributeSubListCompare : IComparer<Variable>
	{
		...
		int IComparer<Variable>.Compare(Variable value1, Variable value2) => Compare(value1, value2);
		...
		/// <param name="value2">Second object to compare</param>
		/// <returns>-1 0 1 depending on comparison</returns>
		protected int Compare(Variable value1, Variable value2) => DoCompare(value1, value2);
		...
		private int DoCompare(Variable value1, Variable value2)
		{
