...
namespace TQVaultAE.GUI
{
	...
	internal partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.characterComboBox.Font = Program.GetFontAlbertusMTLight( 14F * TQVaultData.Database.DB.Scale);
			...
			this.characterLabel.Font = Program.GetFontAlbertusMTLight( 11F * TQVaultData.Database.DB.Scale);
			...
			this.vaultListComboBox.Font = Program.GetFontAlbertusMTLight( 14F * TQVaultData.Database.DB.Scale);
