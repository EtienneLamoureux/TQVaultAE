...
namespace TQVaultAE.GUI
{
	...
	internal partial class VaultMaintenanceDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.targetTextBox = new ScalingTextBox();
			this.instructionsLabel = new ScalingLabel();
			this.okayButton = new ScalingButton();
			this.cancelButton = new ScalingButton();
			this.vaultListComboBox = new ScalingComboBox();
			this.newRadioButton = new ScalingRadioButton();
			this.selectFunctionGroupBox = new System.Windows.Forms.GroupBox();
			this.renameRadioButton = new ScalingRadioButton();
			this.copyRadioButton = new ScalingRadioButton();
			this.deleteRadioButton = new ScalingRadioButton();
			this.sourceLabel = new ScalingLabel();
			this.targetLabel = new ScalingLabel();
