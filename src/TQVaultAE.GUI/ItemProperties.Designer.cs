...
namespace TQVaultAE.GUI
{
	...
	internal partial class ItemProperties
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBox1 = new ScalingCheckBox();
			...
			this.ok.DownBitmap = Resources.MainButtonDown;
			...
			this.ok.Name = "ok";
			this.ok.OverBitmap = Resources.MainButtonOver;
			this.ok.Size = new System.Drawing.Size(137, 30);
			this.ok.SizeToGraphic = false;
			this.ok.TabIndex = 0;
			this.ok.Text = "OK";
			this.ok.UpBitmap = Resources.MainButtonUp;
