...
namespace TQVaultData
{
	public class PlayerLevel
	{
		...
		public static int MaxAttributePoints { get => 168; }

		public static int HealthAndManaIncrementPerPoint { get => 40; }

		public static int AtrributeIncrementPerPoint { get => 4; }

		public static int AtrributePointsPerLevel { get => 2; }

		public static int MinStrength { get => 50; }

		public static int MinDexterity { get => 50; }

		public static int MinIntelligence { get => 50; }

		public static int MinHealth { get => 300; }

		public static int MinMana { get => 300; }
		...
		public static int MaxSkillPoints { get => 282; }

		public static int SkillPointsPerLevel { get => 3; }
