        ...
        public static string TQPath
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(titanQuestGamePath))
                {
                    ...
                    if (!File.Exists(TQExecutable))
                    {
                        ...
                        for (int i = 0; i < libFile.Length; i++)
                        {
                            ...
                            if (libFile[i].Contains("\"" + numLibrary + "\""))
                            {
                                ...
                                {
                                    titanQuestGamePath = lineParts[3].Trim('"') + "\\SteamApps\\common\\Titan Quest Anniversary Edition";
                    ...
                    {
                        titanQuestGamePath = SteamPath + "\\SteamApps\\common\\Titan Quest Anniversary Edition";
                        //System.Windows.Forms.MessageBox.Show(titanQuestGamePath);
                    }
                }
