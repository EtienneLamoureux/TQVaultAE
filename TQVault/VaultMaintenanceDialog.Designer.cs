...
namespace TQVault
{
    ...
    internal partial class VaultMaintenanceDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.targetTextBox = new TQVault.ScalingTextBox();
            this.instructionsLabel = new TQVault.ScalingLabel();
            ...
            this.newRadioButton = new TQVault.ScalingRadioButton();
            this.selectFunctionGroupBox = new System.Windows.Forms.GroupBox();
            this.renameRadioButton = new TQVault.ScalingRadioButton();
            this.copyRadioButton = new TQVault.ScalingRadioButton();
            this.deleteRadioButton = new TQVault.ScalingRadioButton();
            this.sourceLabel = new TQVault.ScalingLabel();
            this.targetLabel = new TQVault.ScalingLabel();
